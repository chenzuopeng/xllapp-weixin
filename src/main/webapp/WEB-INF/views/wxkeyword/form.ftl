...
<table class="save_form_table" border="1">
	        <tr>
				<td class="save_form_field_label"><span>关键词</span></td>
				<td><input class="save_form_field_input" id="keyword" name="keyword"  type="text"  value="<#if entity?has_content>${entity.keyword!}</#if>" /></td>
		    </tr>
	        <tr>
	        ...
	        <tr>
				<td class="save_form_field_label"><span>关键词说明</span></td>
				<td><textarea class="save_form_field_textarea" id="description" name="description" ><#if entity?has_content>${entity.description!}</#if></textarea></td>
		    </tr>
	        <tr>
